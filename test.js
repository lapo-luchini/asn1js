...
tests.push(new Tests('ASN.1', function (t) {
    ...
    ['0100', 'Exception:\nError: BOOLEAN with invalid length 0 at position 0', 'Boolean with zero length'],
    ['01020000', 'Exception:\nError: BOOLEAN with invalid length 2 at position 0', 'Boolean with excessive length'],
    // avoid past bugs
